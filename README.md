...
- pour le contenu de la page 404 vous êtes libres
...
- Pour effectuer la conversion pour pouvez utiliser l'API gratuite : "https://freecurrencyapi.net/api/v2/latest?apikey=YOUR-APIKEY"
